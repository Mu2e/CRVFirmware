...
xst -ifn xst.scr
move selectio_if_wiz_v4_1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\selectio_if_wiz_v4_1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc selectio_if_wiz_v4_1_exdes.ucf selectio_if_wiz_v4_1_exdes

echo 'Running map'
map -timing selectio_if_wiz_v4_1_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm selectio_if_wiz_v4_1_exdes -w routed.ncd routed.vhd
cd ..
