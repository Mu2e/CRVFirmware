...
xst -ifn xst.scr
move SerialTx_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SerialTx_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SerialTx_exdes.ucf SerialTx_exdes

echo 'Running map'
map -timing SerialTx_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm SerialTx_exdes -w routed.ncd routed.vhd
cd ..
