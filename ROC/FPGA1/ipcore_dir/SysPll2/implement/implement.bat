...
xst -ifn xst.scr
move SysPll2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\SysPll2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc SysPll2_exdes.ucf SysPll2_exdes

echo 'Running map'
map -timing -pr b SysPll2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm SysPll2_exdes -w routed.ncd routed.vhd
cd ..
