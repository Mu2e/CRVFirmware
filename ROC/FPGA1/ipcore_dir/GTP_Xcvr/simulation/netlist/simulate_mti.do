...
##Load Design
vsim -t 1ps -L SECUREIP -L SIMPRIM -sdftyp /DEMO_TB_IMP/GTP_Xcvr_top_i=../../implement/results/routed.sdf  +no_notifier +notimingchecks work.DEMO_TB_IMP -voptargs="+acc"
