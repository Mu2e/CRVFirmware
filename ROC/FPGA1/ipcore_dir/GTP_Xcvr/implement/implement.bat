...
COPY GTP_Xcvr_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\GTP_Xcvr_top.ucf -p xc6slx25t-fgg484-3 GTP_Xcvr_top.ngc GTP_Xcvr_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -p xc6slx25t-fgg484-3 -o mapped.ncd GTP_Xcvr_top.ngd
