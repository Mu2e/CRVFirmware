...
xst -ifn xst.scr
move GTPClkDCM_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\GTPClkDCM_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc GTPClkDCM_exdes.ucf GTPClkDCM_exdes

echo 'Running map'
map -timing -pr b GTPClkDCM_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm GTPClkDCM_exdes -w routed.ncd routed.vhd
cd ..
