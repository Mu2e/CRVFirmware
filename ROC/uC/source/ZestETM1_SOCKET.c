...
//tek addition
static void Socket_SendDataNew(SOCKET s);
void Zest_InGoing(SOCKET s);
//
// External functions
...
#define NUM_SOCKETS 2  //tek was 16
...
{
    int len;
    len= recv(g_Sock, eBuf, TX_RX_MAX_BUF_SIZE, 0);             //'SOCKET s, char *buf, int len, int flags'
