...
#define eCMD77_BINARY_DAT 0x77          //FPGA binary File transfer Data type for download packets, added Apr2025
...
#define eFebLdMax120    120             //payLoad Size Max 'PayLdMax' for FEB image downloads
